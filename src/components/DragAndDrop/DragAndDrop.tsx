...
import {COMPLETE_TODO, DELETE_COLUMN_BY_ID, DELETE_TODO, EDIT_TODO, MOVE_ITEM} from "../../redux/constants";
...
export default function DragAndDrop({openDialog}: Props) {
    ...
    const onDragEnd = (result: any, columns: any, setColumns: any) => {
        ...
        // console.log("fromColumnId " + result.source.droppableId, "fromItemId " + (result.source.index + 1))
        // console.log("toColumnId " + result.destination.droppableId, "toItemId  " + (result.destination.index + 1))

        dispatch({
            type: MOVE_ITEM, payload:
                {
                    fromColumnId: result.source.droppableId,
                    toColumnId: result.destination.droppableId,
                    fromItemId: (result.source.index + 1),
                    toItemId: (result.destination.index + 1)
                }
        })

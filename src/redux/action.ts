import {Auth, Item, MoveItemObj, SignForm, TodoColumn, UpdatePassword, User} from "../components/Interfaces";
import {
    ADD_TODO,
    ADD_TODO_SUCCEED,
    AUTHORIZATION,
    ...
    DELETE_COLUMN_BY_ID,
    DELETE_COLUMN_BY_ID_SUCCEED, MOVE_ITEM, MOVE_ITEM_SUCCEED
} from "./constants";
...
export function createTodoSucceed(id: number, text: string, finished: boolean, createdDate: string,updatedItemId: number):
...
export interface MoveItemSucceed {
    type: typeof MOVE_ITEM_SUCCEED,
    payload: MoveItemObj
}
